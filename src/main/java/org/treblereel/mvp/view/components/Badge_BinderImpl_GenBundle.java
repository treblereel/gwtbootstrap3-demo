...
public interface Badge_BinderImpl_GenBundle extends ClientBundle {
  @Source("uibinder.org.treblereel.mvp.view.components.Badge_BinderImpl_GenCss_style.gss")
  Badge_BinderImpl_GenCss_style style();

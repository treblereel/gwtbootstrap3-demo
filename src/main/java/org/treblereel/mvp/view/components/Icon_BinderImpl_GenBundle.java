...
public interface Icon_BinderImpl_GenBundle extends ClientBundle {
  @Source("uibinder.org.treblereel.mvp.view.components.Icon_BinderImpl_GenCss_style.gss")
  Icon_BinderImpl_GenCss_style style();

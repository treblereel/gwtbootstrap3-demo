...
public interface Navbar_BinderImpl_GenBundle extends ClientBundle {
  @Source("uibinder.org.treblereel.mvp.view.components.Navbar_BinderImpl_GenCss_style.gss")
  Navbar_BinderImpl_GenCss_style style();

...
public interface Alert_BinderImpl_GenBundle extends ClientBundle {
  @Source("uibinder.org.treblereel.mvp.view.components.Alert_BinderImpl_GenCss_style.gss")
  Alert_BinderImpl_GenCss_style style();

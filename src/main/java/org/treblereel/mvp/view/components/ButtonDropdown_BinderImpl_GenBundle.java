...
public interface ButtonDropdown_BinderImpl_GenBundle extends ClientBundle {
  @Source("uibinder.org.treblereel.mvp.view.components.ButtonDropdown_BinderImpl_GenCss_style.gss")
  ButtonDropdown_BinderImpl_GenCss_style style();

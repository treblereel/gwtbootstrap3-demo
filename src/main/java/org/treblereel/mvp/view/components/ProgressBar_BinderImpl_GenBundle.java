...
public interface ProgressBar_BinderImpl_GenBundle extends ClientBundle {
  @Source("uibinder.org.treblereel.mvp.view.components.ProgressBar_BinderImpl_GenCss_style.gss")
  ProgressBar_BinderImpl_GenCss_style style();
